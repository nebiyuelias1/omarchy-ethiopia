...
const graphics = [
  ...
  {
    id: "eyuel-square",
    title: "Eyuel Getachew — Square (1:1)",
    speaker: "Eyuel Getachew",
    talk: "Beyond the rice: Building an Agentic Desktop on fedora 44 with omarchy principles",
    format: "1200 × 1200 px (Square)",
    bestFor: "Instagram, Twitter Feed, LinkedIn, Telegram",
    src: "/assets/graphics/speaker-eyuel-getachew-square.png",
    aspect: "aspect-square",
  },
  {
    id: "eyuel-landscape",
    title: "Eyuel Getachew — Landscape (16:9)",
    speaker: "Eyuel Getachew",
    talk: "Beyond the rice: Building an Agentic Desktop on fedora 44 with omarchy principles",
    format: "1200 × 675 px (16:9)",
    bestFor: "Twitter Card, LinkedIn Banner, Presentation Title",
    src: "/assets/graphics/speaker-eyuel-getachew-landscape.png",
    aspect: "aspect-[16/9]",
  },
  {
    id: "lineup-square",
    title: "Featured Speakers Lineup — Square (1:1)",
    speaker: "Dagim Gizachew, Fraol Lemecha & Eyuel Getachew",
    talk: "All Featured Speakers Announcement",
    format: "1200 × 1200 px (Square)",
  ...
  {
    id: "lineup-landscape",
    title: "Featured Speakers Lineup — Landscape (16:9)",
    speaker: "Dagim Gizachew, Fraol Lemecha & Eyuel Getachew",
    talk: "All Featured Speakers Announcement",
    format: "1200 × 675 px (16:9)",
